...
if (!function_exists('zib_shop_get_home_url')) {
    function zib_shop_get_home_url()
    {
        ...
        if (isset($zib_shop->home_url) && null !== $zib_shop->home_url) {
            return $zib_shop->home_url;
        }

        $home_url = trim((string) _pz('shop_home_url', ''));
        if (!$home_url) {
            if (isset($zib_shop->home_url)) {
                $zib_shop->home_url = '';
            }

 ...
 * @LastEditTime : 2026-04-30 14:40:32
 */
...
switch ($tab) {
    ...
    case 'add':
        ...
        $csf_fields[] = array(
            ...
            <li>一行一个邀请码，单行格式为：<code>邀请码 奖励 标识</code></li>
            <li>邀请码、奖励、标识奖励默认使用空格分割，您可以在下方自定义分割符号，与您的数据对应即可</li>
    ...
    default: //文章类型的
        ...
        if ($db_data) {
            ...
            $theads[] = array('width' => '12%', 'orderby' => 'other', 'name' => '标识');

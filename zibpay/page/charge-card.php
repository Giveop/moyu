 ...
 * @LastEditTime : 2026-04-30 14:43:36
 */
...
switch ($tab) {
    ...
    case 'add':
        ...
        $csf_fields[] = array(
            'dependency' => array('add_type', '==', 'auto'),
            'title'      => '标识',
            'desc'       => '对生成的卡密做标记标识，方便后期查找管理<br>注意：标识中不能有<code>shipped</code>字符，系统已占用',
            'id'         => 'auto_remarks',
        ...
        $csf_fields[] = array(
            ...
            <li>一行一个卡密，单行格式为：<code>卡号 密码 面额 标识</code></li>
            <li>卡号、密码、面额、标识默认使用空格分割，您可以在下方自定义分割符号，与您的数据对应即可</li>
        ...
        $csf_fields[] = array(
            ...
            <li>一行一个卡密，单行格式为：<code>卡号 密码 会员参数 标识</code></li>
            <li>卡号、密码、面额、标识默认使用空格分割，您可以在下方自定义分割符号，与您的数据对应即可</li>
        ...
        $csf_fields[] = array(
            ...
            <li>一行一个卡密，单行格式为：<code>卡号 密码 标识 自定义参数</code></li>
        ...
        $csf_fields[] = array(
            ...
            <li>一行一个卡密，单行格式为：<code>密码 标识 自定义参数</code></li>
            <li>默认使用空格分割，您可以在下方自定义分割符号，与您的数据对应即可</li>
            <li>单次导入数量太多可能会对服务器性能造成影响</li>
    ...
    default:
        ...
        if ($db_data) {
            ...
            $theads[] = array('width' => '8%', 'orderby' => 'other', 'name' => '标识');

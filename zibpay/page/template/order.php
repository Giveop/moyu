                    ...
                    <template #content>
                        <div class="flex xx">
                            ...
                            <div class="flex ac jsb mb6" v-if="scope.row.prices.total_discount && scope.row.prices.total_discount > 0">
                                <div class="opacity5 mr6 flex0">{{ (scope.row.prices.rebate_discount && scope.row.prices.rebate_discount == scope.row.prices.total_discount ? '推广':'') + '优惠'}}</div>
                    ...
                    <template #content>
                        <div v-if="scope.row.status == -1">
                            <div class="opacity5" v-if="scope.row.order_data.close_reason">
                                {{scope.row.order_data.close_reason || '交易已关闭'}}
                            </div>
                            <div class="tooltip-link-box">
                                <a @click="paymentOrderDialog(scope.row)" href="javascript:void(0)">手动补单</a>
                            </div>
                        </div>
                        <div v-if="scope.row.status == 0">
                            <div class="flex xx">
                                ...
                                <div class="tooltip-link-box">
                                    <a @click="paymentOrderDialog(scope.row)" href="javascript:void(0)">手动支付</a>
                                </div>
                            </div>
                        </div>
                        <div v-if="scope.row.status == 1">

 ...
 * @LastEditTime : 2026-04-30 15:13:58
...
switch ($tab) {
    ...
    case 'add':
        ...
        $csf_fields[] = array(
            ...
            <li>一行一个卡密，单行格式为：<code>优惠码 绑定文章ID 折扣方式 折扣数额 有效期 优惠码名称 重复使用次数 标识</code></li>
    ...
    default:
        ...
        if ($db_data) {
            ...
            $theads[] = array('width' => '10%', 'orderby' => 'post_id', 'name' => '绑定商品');
            $theads[] = array('width' => '8%', 'orderby' => '', 'name' => '使用限制');
            $theads[] = array('width' => '8%', 'orderby' => '', 'name' => '状态');
            $theads[] = array('width' => '10%', 'orderby' => 'create_time', 'name' => '创建时间');
            $theads[] = array('width' => '10%', 'orderby' => 'modified_time', 'name' => '更新时间');
            $theads[] = array('width' => '10%', 'orderby' => '', 'name' => '优惠码名称');
            $theads[] = array('width' => '15%', 'orderby' => 'other', 'name' => '标识');
